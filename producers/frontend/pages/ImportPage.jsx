      ...
      {step === 0 && (
        <div className="section-card">
          <div className="tab-bar">
            <div className={`tab${inputMode === 'file' || !inputMode ? ' active' : ''}`} onClick={() => setInputMode('file')}>Upload File</div>
            <div className={`tab${inputMode === 'url' ? ' active' : ''}`} onClick={() => setInputMode('url')}>Google Sheet</div>
            <div className={`tab${inputMode === 'text' ? ' active' : ''}`} onClick={() => setInputMode('text')}>Paste Text</div>
          </div>
