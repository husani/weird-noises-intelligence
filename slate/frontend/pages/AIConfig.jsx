/**
 * Slate AI Configuration — models and prompts for each AI behavior.
 * Replicates the Producers AIConfig pattern.
 */

import React, { useEffect, useState } from 'react'
import {
  getAIBehaviors, updateAIBehavior, getModelOptions,
} from '@slate/api'
...
export default function AIConfig() {
  ...
  function loadAll() {
    setLoading(true)
    Promise.all([getAIBehaviors(), getModelOptions()])
      .then(([b, m]) => {
        setBehaviors(b)
        setModelOptions(m.options || m || {})
